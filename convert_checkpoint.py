...
"""
Description: converts meta official (pytorch) weights to lightning ai weights
Sample usage:

```bash
python -m convert_checkpoint -h

python -m convert_checkpoint converted
```
"""
...
def meta_weights_for_nano_model(
    *,
    ...
    # need to copy tokenizer if storing lightning weights in different directory
    # shutil.copy(checkpoint_dir / "tokenizer.model", output_dir)
    ...
    torch.save(combined, output_dir / "lit_model.pth")
